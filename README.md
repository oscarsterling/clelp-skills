...
- **Packages and scripts** (`clelp-mcp-server`, `claude-telegram-remote`, `yburn`) have their own README with install commands. `clelp-mcp-server` publishes to npm; `yburn` publishes to PyPI.
