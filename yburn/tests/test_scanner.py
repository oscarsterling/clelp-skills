...
class TestCronJobFields:
    ...
    def test_session_target(self, sample_jobs):
        ...
        flush = next(j for j in sample_jobs if j.name == "Pre-Snapshot Cache Flush")
...
class TestScheduleParsing:
    ...
    def test_cron_expr_without_timezone(self, sample_jobs):
        ...
        update_check = next(j for j in sample_jobs if j.name == "Dependency Update Check")
...
class TestPayloadParsing:
    ...
    def test_system_event_text(self, sample_jobs):
        ...
        assert flush.payload_text.startswith("PRE-SNAPSHOT FLUSH:")
...
class TestModelExtraction:
    ...
    def test_model_present(self, sample_jobs):
        ...
        research = next(j for j in sample_jobs if j.name == "Market Research Digest")
